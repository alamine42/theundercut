          ...
          <div className="grid gap-6 md:grid-cols-2">
            {fastestPole && (
              <article className="border-2 border-ink bg-paper p-6">
                ...
                <p className="text-3xl font-bold font-mono">{fastestPole.pole_time}</p>
            ...
            {fastestLap && (
              <article className="border-2 border-ink bg-paper p-6">
                ...
                <p className="text-3xl font-bold font-mono">{fastestLap.fastest_lap_time}</p>
                <p className="mt-2 text-muted">
                ...
                <table className="w-full">
                  <thead className="bg-ink text-paper">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-right text-xs font-semibold uppercase tracking-wide">FL Time</th>
                    </tr>
                  </thead>
                    ...
                    {trends
                      ...
                      .map((trend) => (
                        <tr key={trend.year} className="hover:bg-ink hover:text-paper transition-colors">
                          ...
                          <td className="px-6 py-4 text-sm">{trend.pole_driver || "—"}</td>
                          <td className="px-6 py-4 text-sm text-right font-mono">
                            {trend.pole_time || "—"}
                          </td>
                          <td className="px-6 py-4 text-sm">{trend.fastest_lap_driver || "—"}</td>
                          <td className="px-6 py-4 text-sm text-right font-mono">
